...
@tree.command(name= "ping", description= "Ping a alguien", guild = discord.Object(id = 0000)) # Introduce the id of the server where you want the bot to be, in int format
...
@tree.command(name="ban", description="Ban someone", guild = discord.Object(id = 0000)) # Introduce the id of the server where you want the bot to be, in int format
async def ban(interaction: discord.Integration, member: discord.User): # We create the function ban
    if interaction.user.guild_permissions.administrator: # If the user has the administrator permission
        ...
        await interaction.response.send_message(embed=discord.Embed(title="You don't have permissons to perform this action", description="This action requires the administrator permission", color=0xff0000))

@tree.command(name="unban", description="Unban someone", guild = discord.Object(id = 0000)) # Introduce the id of the server where you want the bot to be, in int format
...
@tree.command(name="kick", description="Kick someone", guild = discord.Object(id = 0000)) # Introduce the id of the server where you want the bot to be, in int format
...
@tree.command(name="shoot", description="Shoot someone", guild = discord.Object(id = 0000)) # Introduce the id of the server where you want the bot to be, in int format
...
@tree.command(name="mute", description="Mute someone", guild = discord.Object(id = 0000)) # Introduce the id of the server where you want the bot to be, in int format
...
@tree.command(name="unmute", description="Unmute someone", guild = discord.Object(id = 0000)) # Introduce the id of the server where you want the bot to be, in int format
...
@tree.command(name="deafen", description="Deafen someone", guild = discord.Object(id = 0000)) # Introduce the id of the server where you want the bot to be, in int format
...
@tree.command(name="undeafen", description="Undeafen someone", guild = discord.Object(id = 0000)) # Introduce the id of the server where you want the bot to be, in int format
...
@tree.command(name="help", description="Shows all the available commands", guild = discord.Object(id = 0000)) # Introduce the id of the server where you want the bot to be, in int format
